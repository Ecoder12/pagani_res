...
doc.moveDown();
  ...
  doc.text(`I understand that Pagani's is not responsible for any damage to the vehicle resulting from any act of nature including, without limitation, damage caused by hail, wind, fire, or flood.`);
  doc.moveDown();
  ...
  doc.text(`ENTIRE AGREEMENT. The terms contained in this Repair Authorization constitute the entire agreement between you and Pagani's. This Repair Authorization shall supersede all prior oral and written discussions, agreements, and understandings of the parties regarding the subject matter of this Authorization. No modification, amendment, supplement to or waiver of this Repair Authorization or its terms and conditions shall be binding upon either party unless made in writing and signed by both you and an authorized manager of Pagani's.`);
  doc.moveDown();
