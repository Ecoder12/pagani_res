...
function generateFile(content) {
  ...
  const fileName = `PG${formattedDate}${formattedTime}.txt`;
...
expenses.
      ...
      I understand that Pagani's is not responsible for any damage to the vehicle resulting 
from any act of nature including, without limitation, damage caused by hail, wind, fire, or flood.

      I understand and agree that Pagani's may provide my contact information to a third-party
organization that may contact me for the sole purpose of conducting a customer satisfaction survey.

      LIMITED WARRANTY. Subject to the specified exclusions and exceptions, Pagani's provides a 
...
party other than Pagani's, abuse, misuse, neglect, acts of God, or environmental damage. 
...
Pagani's. This Repair Authorization shall supersede all prior oral and written discussions, agreements, and 
...
writing and signed by both you and an authorized manager of Pagani's.

      I authorize any and all supplements payable direct to Pagani’s Downtown Car Care LLC.  I authorize Pagani’s Downtown
...
doc.moveDown();
  ...
  doc.text(`I understand that Pagani’s Downtown Car Care LLC is not responsible for any damage to the vehicle resulting from any act of nature including, without limitation, damage caused by hail, wind, fire, or flood.`);
  doc.moveDown();

  doc.text(`I understand and agree that Pagani’s Downtown Car Care LLC may provide my contact information to a third-party organisation that may contact me for the sole purpose of conducting a customer satisfaction survey.`);
  doc.moveDown();

  doc.text(`LIMITED WARRANTY. Subject to the specified exclusions and exceptions, Pagani’s Downtown Car Care LLC provides a limited warranty for the work performed under this Repair Authorization. This limited warranty includes all repairs, paint and workmanship on sheet metal, frame, unitized chassis components, and mechanical items, but specifically excludes electric systems. This limited warranty is subject to any manufacturer’s warranty covering parts and materials. This limited warranty is non-transferable and valid for as long as I own the vehicle. During the limited warranty period, Pagani’s Downtown Car Care LLC will repair or replace any defects caused by Pagani’s Downtown Car Care LLC or its agents. All warranty repairs must be performed at one of Pagani’s Downtown Car Care LLC facilities; any repairs or alterations to the vehicle performed Non-Pagani’s Downtown Car Care LLC facility in any manner whatsoever shall automatically void this limited warranty. This limited warranty shall not apply to repairs necessitated by any cause beyond the reasonable control of Pagani’s Downtown Car Care LLC, including any defects, damage, or malfunctions caused by or resulting from unauthorized service or parts, improper or inadequate vehicle maintenance, alterations, accidents, modification or repairs, subsequent repairs performed by a party other than Pagani’s Downtown Car Care LLC, abuse, misuse, neglect, acts of God, or environmental damage. THE WARRANTIES AS SET FORTH IN THIS SERVICE CONTRACT ARE IN LIEU OF ALL OTHER WARRANTIES, EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, ANY IMPLIED WARRANTY OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE.`);
  doc.moveDown();

  doc.text(`LIMITATION OF LIABILITY. In no event shall Pagani’s Downtown Car Care LLC be liable for consequential, special, or indirect damages of any nature, and Pagani’s Downtown Car Care LLC maximum liability shall be no greater than the amount actually paid to, and received by, Pagani’s Downtown Car Care LLC for the services performed on the vehicle.`);
  doc.moveDown();
  ...
  doc.text(`ENTIRE AGREEMENT. The terms contained in this Repair Authorization constitute the entire agreement between you and Pagani’s Downtown Car Care LLC. This Repair Authorization shall supersede all prior oral and written discussions, agreements, and understandings of the parties regarding the subject matter of this Authorization. No modification, amendment, supplement to or waiver of this Repair Authorization or its terms and conditions shall be binding upon either party unless made in writing and signed by both you and an authorized manager of Pagani’s Downtown Car Care LLC.`);
  doc.moveDown();

  doc.text(`I authorize any and all supplements payable direct to Pagani’s Downtown Car Care LLC.  I authorize Pagani’s Downtown Car Care LLC POWER OF ATTORNEY TO SIGN supplement payments.`);
  doc.moveDown();
  ...
  const fileName = `PG${formattedDate}${formattedTime}.pdf`;
  const filePath = `./${fileName}`;
